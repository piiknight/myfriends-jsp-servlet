            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title-w3-agile">Sửa thông tin người dùng</h3>
                            </div>
                            <%
                            ...
                            <div class="frame-content">
                            	<form id="form-add" class="my-form" method="post">
	                            	...
	                            	<input type="text" name="username" value="<%=user.getUsername() %>" class="my-input" disabled />
	                            	<label>Password: </label>
	                            	<input type="password" name="password" value="" class="my-input"/>
	                            	<label>Fullname: </label>
	                            	<input type="text" name="fullname" value="<%=user.getFullname() %>" class="my-input"/>
	                            	<br />
